...
- **Никаких упоминаний внешних инструментов/ассистентов** в коде, комментариях
  и сообщениях коммитов. Автор коммитов — только пользователь. Коммиты **без**
  trailer-а `Co-Authored-By`.
